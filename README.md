...
@inproceedings{QuispeArias2025LeaderFollower, author = {Sebasti{\'a}n Quispe Arias and Markus Endler and Bruno Jos{\'e} Olivieri de Souza}, title = {Leader-Follower Sizing in Heterogeneous UAV Swarms for SAR: Latency-Coverage Trade-Offs via Discrete-Event Simulation}, booktitle = {Proceedings of {LAFUSION} 2025}, year = {2025}, note = {Paper ID 23} }
FIN README.md